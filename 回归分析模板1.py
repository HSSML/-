...
def athlete_performance_analysis(body_fat_data, performance_data):
    ...
    plt.title('体脂率与成绩之间的回归分析（张三）', fontsize=52, color='darkblue')  # 设置标题的字体大小和颜色
...
# 示例数据（张三）
body_fat_data = {
    '日期': ['2023/12/28', '2024/1/4', '2024/1/11', '2024/1/18', '2024/2/1',
           '2024/2/16', '2024/3/8', '2024/3/28', '2024/4/18', '2024/4/25',
           '2024/5/2', '2024/5/9', '2024/6/6', '2024/6/13', '2024/6/21',
           '2024/7/11', '2024/8/1', '2024/8/8', '2024/8/22', '2024/8/29',
           '2024/9/5'],
    '体脂': [11.92, 11.74, 11.64, 12.13, 12.17, 11.85, 12.13, 12.83, 11.54,
           11.68, 11.46, 11.46, 10.86, 10.96, 10.82, 10.71, 11.03, 10.93,
           10.96, 10.75, 10.93]
}

performance_data = {
    '日期': ['2024/4/10', '2024/4/14', '2024/5/19', '2024/5/19', '2024/5/28',
           '2024/5/29', '2024/6/16', '2024/6/28', '2024/6/29', '2024/7/18',
           '2024/9/14', '2024/9/15', '2024/9/16'],
    '成绩(秒)': [52.55, 52.42, 52.04, 51.43, 52.2, 51.01, 52.14, 51.23,
              51.21, 51.64, 51.25, 50.64, 50.93]
}
